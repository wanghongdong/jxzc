...
/**
 * @ClassPath com.jxzc.web.web.BaZhi
 * @ClassName BaZhi
 * @Description TODO
 * @Author whd
...
public class BaZi {
    ...
    static SimpleDateFormat chineseMinDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
     ...
     * 六十甲子
     */
    public static final String[] JIA_ZHI = {
     ...
     * @author kongqz
     * */
    private String getYearGanZhi() {
        //1864年是甲子年，每隔六十年一个甲子
        int idx = (year - 1864) % 60;
        //没有过春节的话那么年还算上一年的，此处求的年份的干支
        String y = JIA_ZHI[idx];
    ...
    public BaZi(Calendar cal) {
        ...
        month = iMonth;
        day = offset + 1;
        hour = (cal.get(Calendar.HOUR_OF_DAY) + 1) / 2 + 1;
    }
    ...
    public String toString() {
        return getYearStr(year) + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(day) + " " + Zhi[hour-1] + "时";
    }
    ...
    public static String getSixtyDay() {
        ...
        for (int i = 0; i < 60; i++) {
            temp.append(",/").append(cyclicalm(i)).append("/");
        }
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            cal.setTime(chineseMinDateFormat.parse("1993-03-16 19:30"));
...
//        int i = returnHours(13);
//        System.out.println(i + "___" + Zhi[i-1]);
    }
}
