...
import com.jxzc.web.bean.ErrorInfo;
...
//                break;
            case 404:
                errorInfo.setCode(HttpStatus.NOT_FOUND.value());  // 将错误码传递过去
                break;
            case 500:
                errorInfo.setCode(INIT_ERROR_CODE);  // 将错误码传递过去
                break;
...
//                break;
        ...
        mv.setViewName("/common/error/"+DEFAULT_ERROR_VIEW+errorInfo.getCode());
        return mv;
    }
